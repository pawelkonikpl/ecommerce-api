...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Cart":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Cart": %w`, err)
			}
			switch resolverName {
			...
			case "findCartByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findCartByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindCartByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Cart": %w`, err)
				}
...
func entityResolverNameForCart(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
